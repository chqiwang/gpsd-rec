...
log_info_file = './amazon_elec_new/reviews_Electronics_5.json'
meta_file = './amazon_elec_new/meta_Electronics.json'
log_df_pickle = './amazon_elec_new/reviews.pkl'
meta_df_pickle = './amazon_elec_new/meta.pkl'

item2index = './amazon_elec_new/item2index.txt'
cate2index = './amazon_elec_new/cate2index.txt'
pretrain_train_file = './amazon_elec_new/pretrain_dataset.txt'
ft_train_file = './amazon_elec_new/ft_train_dataset.txt'
ft_eval_file = './amazon_elec_new/ft_eval_dataset.txt'
...
def gen_dataset(user_df, item_df, item_map):
    ...
    split_time = user_last_touch_time_sorted[
        int(len(user_last_touch_time_sorted) * 0.7)]  # split by user last touch time
    ...
    for uid, hist in user_df:
        ...
        target_item, target_item_cate, label, neg_item, neg_item_cate, neg_label = sample_neg_item(item_hist, cate_hist,
                                                                                                   -1)
...
def main():
    ...
    meta_df['categories'] = meta_df['categories'].apply(lambda x: '&&'.join(x[0]))
